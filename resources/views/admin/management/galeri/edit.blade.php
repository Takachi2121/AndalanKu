...
@section('subtitle', 'Ubah Keterangan Galeri Menjadi Yang Terbaru.')
            ...
            <div class="mb-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-9">
                        ...
                        <!-- Preview Gambar -->
                        <div class="mt-3">
                            <img id="preview-thumbnail" src="{{ $Galeri->thumbnail ? asset('img/data/Galeri/' . $Galeri->thumbnail) : '#' }}"
                            alt="Preview Gambar Galeri"
                            style="max-width: 220px; max-height: 220px; {{ $Galeri->thumbnail ? '' : 'display: none;' }} border: 1px solid #ddd; padding: 5px; border-radius: 4px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="mb-4">
                ...
                <div class="col-md-9">
                    ...
                    <input type="file" class="form-control" id="dokumentasi" name="dokumentasi" accept=".png, .jpg">
                    <div class="form-text text-muted mt-2">
                        Note: Minimal ukuran foto 1920 x 792 dan bertipe PNG / JPG
                    </div>
                    ...
                    <!-- Preview Gambar -->
                    <div class="mt-3">
                        <img id="preview-dokumentasi" src="{{ $Galeri->dokumentasi ? asset('img/data/Galeri/' . $Galeri->dokumentasi) : '#' }}"
                        alt="Preview Gambar Galeri"
                        style="max-width: 220px; max-height: 220px; {{ $Galeri->dokumentasi ? '' : 'display: none;' }} border: 1px solid #ddd; padding: 5px; border-radius: 4px;">
                    </div>
                </div>
                <div class="col-md-9">
                    <label for="rancangan" class="form-label">Rancangan Acara </label>
                    <input type="file" class="form-control" id="rancangan" name="rancangan" accept=".png, .jpg">
                    <div class="form-text text-muted mt-2">
                        Note: Minimal ukuran foto 1920 x 792 dan bertipe PNG / JPG
                    </div>
                    ...
                    <!-- Preview Gambar -->
                    <div class="mt-3">
                        <img id="preview-rancangan" src="{{ $Galeri->rancangan ? asset('img/data/Galeri/' . $Galeri->rancangan) : '#' }}"
                        alt="Preview Gambar Galeri"
                        style="max-width: 220px; max-height: 220px; {{ $Galeri->rancangan ? '' : 'display: none;' }} border: 1px solid #ddd; padding: 5px; border-radius: 4px;">
                    </div>
                </div>
            </div>
